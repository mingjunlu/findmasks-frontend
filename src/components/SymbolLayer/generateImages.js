const generateImages = () => {
    ...
    const imageData = [
        { category: 'pharmacy', status: 'sufficient' },
        { category: 'pharmacy', status: 'acceptable' },
        { category: 'pharmacy', status: 'insufficient' },
        { category: 'health-center', status: 'sufficient' },
        { category: 'health-center', status: 'acceptable' },
        { category: 'health-center', status: 'insufficient' },
    ];

    return imageData.map(({ category, status }) => {
